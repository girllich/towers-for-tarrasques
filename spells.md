...
|------------|----------|------------|-------------|-------------------------|
| Luminary Orb | Minor | 1 AP | Creates a weak light | Illuminates a small area for 1 hour |
| Zephyr's Spark | Minor | 2 AP | Fires a weak bolt of electricity | 1d6 electrical damage |
| Cheetah's Grace | Minor | 5 AP | Makes the selected PC move faster | +2 to AP for 10 minutes |
| Artisan's Touch | Minor | 5 SP | Makes the selected PC more skilled | +2 to a selected skill for 10 minutes |
| Dismay | Minor | 5 SP | Decreases the morale of the victim | -2 to victim's morale for 1 hour |
| Ember Wall | Minor | 5 SP | Fills the selected space with a short-lasting wall of fire | Creates a wall of fire that causes 1d4 fire damage to anything passing through |
| Unveil | Minor | 35 EP, 35 AP | Identifies all the unidentified items | The effects of all unidentified items are made clear |
| Monster's Lore | Minor | 5 AP | Receives information about the targeted monster | Understands monster's alignments, type, and powers |
| Ensnare | Minor | 5 AP | Covers the target with sticky goo | Reduces target's AP by half |
| Glimpse | Minor | 1 AP | Allows you to see everything in a short radius | Reveals all hidden objects and creatures within a small radius |
| Venomous Touch | Minor | 2 AP | Poisons the target creature | Inflicts target with poison causing 1d4 damage per turn for 4 turns |
| Inferno Strike | Minor | 5 AP | Fires a decent-sized bolt of flame at the target | Deals 2d6 fire damage |
| Sloth's Curse | Minor | 5 AP | Makes the victim get half its usual number of actions | Reduces target's action points by half for 10 minutes |
| Fool's Lance | Minor | 5 AP | Makes the victim incompetent | Reduces all of target's skills by 2 for 10 minutes |
...
| Eagle's Speed | Major | 5 AP, 5 EP | Makes the selected PC get twice the usual number of actions | Doubles target's base action points for 10 minutes 
...
| Capture Template | Major | 70 EP, 10 AP | Stores a target monster in your mind | Stores a defeated monster's essence for future use |
| Instantiate | Major | 10 AP, 10 EP | Summons a monster you have memorized | Summons a previously defeated monster to assist for 10 minutes |
...
| Elderfire | Greater | 10 EP | Creates a space of elderfire, killing everyone and everything | Causes a massive explosion, dealing 10d6 fire damage to all creatures in a large radius |
